...
public class C7_IfElseIf2 {
	...
	public static void main(String[] args) {
		 ...
		 *   carpimini yazdirin, sayilarin ikisi  farkli isaretlere
		 *    sahipse “farkli isaretlerde sayilarla islem yapamazsin”
		 *     yazdirin,  sayilardan sifira esit olan varsa 
		...
		if (sayi1==0 || sayi2==0) {
			...
			System.out.println("sayilarin isaretleri farkli iken islem yapilamaz ");
		}else {
